...
public sealed class DevelopmentPhoneVerificationProvider : PhoneVerificationProvider
{
    ...
    {
        // Unknown inputs fail closed. Only this documented synthetic phone can pass.
        var result = (msisdn, idType, idNumber) switch
        {
            ("254701234567", "01", "mock-verified") => new PhoneVerificationResult(true, false, "Synthetic identity accepted."),
            ("254701234567", "01", "mock-unavailable") => new PhoneVerificationResult(false, true, "Simulated provider outage."),
            ("254701234567", "01", "mock-unconfigured") => new PhoneVerificationResult(false, true, "Simulated missing configuration.", false),
