...
public class ProviderModeGuardTests
{
    ...
    public void ProductionModesRemainReal(string environmentName)
    {
        ...
        TandoProviderModeGuard.Validate("Splice", "Splice", environment);
        Assert.Throws<InvalidOperationException>(() => TandoProviderModeGuard.Validate("Mock", "Daraja", environment));
        Assert.Throws<InvalidOperationException>(() => TandoProviderModeGuard.Validate("Mock", "Splice", environment));
    }
    ...
    public void DevelopmentAllowsOnlyExplicitMockOrProductionAdapterModes()
    {
        ...
        TandoProviderModeGuard.Validate("Mock", "Splice", environment);
        TandoProviderModeGuard.Validate("Daraja", "Daraja", environment);
        TandoProviderModeGuard.Validate("Splice", "Splice", environment);
        Assert.Throws<InvalidOperationException>(() => TandoProviderModeGuard.Validate("AnythingElse", "Splice", environment));
    }
    ...
    public async Task HostedGuardChecksTheLoadedConfigurationBeforeServerStartup()
    {
        ...
        {
            new System.Collections.Generic.KeyValuePair<string, string?>("Tando:PhoneVerification:Mode", "Daraja"),
            new System.Collections.Generic.KeyValuePair<string, string?>("Tando:Payments:Mode", "Mock")
        }).Build();
